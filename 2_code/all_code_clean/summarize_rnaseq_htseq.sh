...
TN_COUNT_DIR="${PROJECT_DIR}/6_differential_gene_analysis/rna_counting/canu"
OUTDIR="${PROJECT_DIR}/6_differential_gene_analysis/rna_counting_summary/canu"

mkdir -p "$OUTDIR"

SUMMARY="${OUTDIR}/rnaseq_htseq_count_summary.tsv"
