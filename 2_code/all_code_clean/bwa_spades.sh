...
#SBATCH -p pelle
#SBATCH -J bwa_spades_mapping
#SBATCH -t 06:00:00
#SBATCH -n 2
#SBATCH --mail-type=ALL
#SBATCH -o bwa_spades_mapping_%j.out
#SBATCH -e bwa_spades_mapping_%j.err
...
REFERENCE_FASTA="${PROJECT_DIR}/4_genome_assembly/spades_4947505/spades_contigs.fasta"
REFERENCE_NAME="spades"
...
echo "Starting BWA mapping to SPAdes assembly"
...
echo "BWA mapping to SPAdes assembly finished."
